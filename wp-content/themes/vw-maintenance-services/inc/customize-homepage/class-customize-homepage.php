...
if ( ! class_exists( 'VW_Maintenance_Services_Content_Creation' ) ) :

	/**
	 * VW_Maintenance_Services_Content_Creation class.
	 */
	class VW_Maintenance_Services_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Maintenance_Services_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Maintenance_Services_Content_Creation' );
