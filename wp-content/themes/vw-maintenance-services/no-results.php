...
<h1 class="entry-title"><?php esc_html_e( 'Nothing Found', 'vw-maintenance-services' ); ?></h1>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<div class="error-btn">
		<a class="view-more" href="<?php echo esc_url(home_url() ); ?>"><?php esc_html_e( 'Back to Home Page', 'vw-maintenance-services' ); ?><i class="fa fa-angle-right"></i></a>
	</div>
<?php endif; ?>